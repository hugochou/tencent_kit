...
class TencentUserInfoResp extends TencentApiResp {
  ...
  factory TencentUserInfoResp.fromJson(Map<String, dynamic> json) => _$TencentUserInfoRespFromJson(json);
  ...
  final String figureurlQq2; // 大小为100×100像素的QQ头像URL。需要注意，不是所有的用户都拥有QQ的100x100的头像，但40x40像素则是一定会有。
